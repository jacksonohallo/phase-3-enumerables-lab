...
spiciest_food= spicy_foods.filter{|heat| heat[:heat_level]>5 } 
...
def average_heat_level(spicy_foods)
 ...
 sum_total= spicy_foods.sum {|ad| ad[:heat_level]}

 return sum_total/spicy_foods.size
